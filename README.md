...
# 前言
&emsp;&emsp;目前，我下的日本**艾薇**电影越来越多，也意味着日本电影要**集中地管理**，形成本地媒体库。现在有两款主流的日本电影元数据获取器，"EverAver"和"Javhelper"。前者的优点是元数据获取比较全，缺点是不能批量处理；后者优点是可以批量处理，但是元数据不够全。<br>
...
- - -
**tg官方电报群:[ 点击进群](https://t.me/AV_Data_Capture_Official)** **某些地区需要代理**<br>
