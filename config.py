...
if __name__ == "__main__":
    ...
    evprint('config.success_folder()')
    evprint('config.soft_link()')
    evprint('config.failed_move()')
    evprint('config.auto_exit()')
    evprint('config.proxy().enable')
    evprint('config.proxy().retry')
    evprint('config.naming_rule()')
    evprint('config.location_rule()')
    evprint('config.update_check()')
    evprint('config.sources()')
    evprint('config.escape_literals()')
    evprint('config.escape_folder()')
    evprint('config.debug()')
    evprint('config.is_transalte()')
    evprint('config.get_transalte_engine()')
    # evprint('config.get_transalte_appId()')
    evprint('config.get_transalte_key()')
    evprint('config.get_transalte_delay()')
    evprint('config.transalte_values()')
    evprint('config.actor_gender()')
    evprint('config.multi_threading()')
    evprint('config.del_empty_folder()')
