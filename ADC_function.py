    ...
    if tranlate_to_sc:
        dict_gen = {'中文字幕': '中文字幕',
                    ...
                    '監禁': '禁闭', '浣腸': '灌肠', '顔射': '恋物癖', '顔面騎乗': '面部骑行', '騎乗位': '女牛仔', 'キス・接吻':
                        ...
                        '拘束', '拷問': '酷刑', 'ごっくん': '暨', '潮吹き': '潮吹', 'シックスナイン': '六十九', '縛り・緊縛': '绑/束缚',
                    '羞恥': '羞耻', '触手': '触觉', '食糞': '食粪', 'スカトロ': '蹲', 'スパンキング': '打屁股', '即ハメ':
                    ...
                    '妄想族': '妄想族', '16時間以上作品': '16小时或以上的工作', '3D': '3D', '4時間以上作品':
                        '4小时或以上的工作', 'プレステージ30％OFF': 'XXXX', '豊彦・山と空・ヒプノシスRASH他30％OFF':
                        'XXXX', '熟女JAPAN・人妻援護会他30％OFF':
                        'XXXX', 'ブランドストア30％OFF！': 'XXXX',
